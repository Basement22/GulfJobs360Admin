...
import PackagesTablePagination from "components/Packages/PackagesTablePagination";
            ...
            <Container className="mt-5" fluid>
                <Row>
                    <Col className="mb-5 mb-xl-0" xl="8">
                        <div>
                            <h1 style={{ display: 'inline-block' }} className="mr-1"> Packages </h1>
                            <AddAdminModal />
                        </div>
                    </Col>
                </Row>
...
export async function getStaticProps() {
    ...
    const res = await fetch(`${DOMAIN}/packages`)
